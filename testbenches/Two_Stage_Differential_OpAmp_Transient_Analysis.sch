...
N 670 1320 670 1440 {lab=GND}
N 670 1180 670 1260 {lab=vdd}
N 780 1320 780 1440 {lab=GND}
N 670 1440 780 1440 {lab=GND}
N 780 1170 780 1260 {lab=vb2}
N 1210 1140 1210 1240 {lab=vout}
N 1210 1140 1220 1140 {lab=vout}
N 1210 1240 1880 1240 {lab=vout}
N 1880 1220 1880 1240 {lab=vout}
N 1880 1070 1880 1220 {lab=vout}
...
C {devices/code.sym} 670 910 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {simulator_commands_shown.sym} 2260 850 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
...
C {vsource.sym} 670 1290 0 0 {name=vdd value=1.8 savecurrent=false}
C {lab_wire.sym} 670 1180 0 0 {name=p4 sig_type=std_logic lab=vdd}
C {gnd.sym} 670 1440 0 0 {name=l5 lab=GND}
C {vsource.sym} 780 1290 0 0 {name=vb2 value="PULSE(0.3 1.4 10n 100p 100p 0.5 1)" savecurrent=false}
C {lab_wire.sym} 780 1170 2 0 {name=p9 sig_type=std_logic lab=vb2}
