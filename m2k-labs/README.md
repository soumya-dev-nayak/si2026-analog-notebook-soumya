...
<p align="center">
  <em>Figure: Linux Familiarization – ADALM Labs</em><br>
  <em>Overview of basic Linux commands and environment navigation used during ADALM laboratory setup and analog design workflow.</em>
</p>
...
<p align="center">
  <em>Figure: ADALM Lab 01 – Voltage Check Circuit</em><br>
  <em>Basic voltage verification setup used in ADALM experiments to validate supply levels and ensure correct probe measurement before performing further analog measurements.</em>
</p>
...
<p align="center">
  <em>Figure: ADALM Lab 02 – Voltage Divider Circuit</em><br>
  <em>Resistive voltage divider setup demonstrating how input voltage is scaled down using two resistors, forming a basic analog signal conditioning stage.</em>
</p>
...
<p align="center">
  <em>Figure: ADALM Lab 03 – Thevenin Equivalent Circuit</em><br>
  <em>Demonstration of Thevenin’s theorem using a simplified equivalent circuit to replace a complex network with an equivalent voltage source and resistance.</em>
</p>
...
<p align="center">
  <em>Figure: 1 kHz Sine and Square Waveforms</em><br>
  <em>Comparison of 1 kHz sine and square signals used to observe differences in waveform shape, harmonics, and time-domain behavior in basic signal analysis.</em>
</p>
...
<p align="center">
  <em>Figure: FFT Analysis of Sine and Square Waveforms</em><br>
  <em>Frequency-domain representation comparing sine and square signals, highlighting harmonic structure where sine shows a single dominant peak and square wave exhibits multiple harmonic components.</em>
</p>
...
<p align="center">
  <em>Figure: FFT of Sine Wave</em><br>
  <em>Frequency-domain analysis of a pure sine wave showing a single dominant peak at the fundamental frequency, demonstrating minimal harmonic distortion.</em>
</p>
...
<p align="center">
  <em>Figure: Detailed FFT of Sine Wave</em><br>
  <em>High-resolution frequency-domain analysis of a sine wave showing precise spectral components, noise floor behavior, and improved frequency resolution compared to basic FFT visualization.</em>
</p>
