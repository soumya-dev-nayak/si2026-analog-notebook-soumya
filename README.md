...
- Plotted Id vs Vds using ngspice.
...
- Analysis of different types of first-order RC circuit configurations.
- Analysis and finding of Vout, gain, Wp, etc. parameters of LC and RC, CR circuits and their different configurations.

### Session 2

#### Op-Amp Circuit Analysis
- Solved and analyzed different Op-Amp circuit configurations along with their gain and impedance findings.

#### Open Circuit Time Constant
- Derived and analyzed the expression for the open circuit time constant for:
  - A simple RC circuit
  - Different RC circuit configurations
...
#### Frequency Response
- Analysis and frequency response of linear circuits (high-pass/low-pass).
- AC analysis of the filters was done using Bode plots.
...
- A simple voltage divider circuit and its measurements using [ADALM2000](https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/adalm2000.html) and [SCOPY](https://github.com/analogdevicesinc/scopy) software.
...
- Modelling the MEMS microphone in XSCHEM for simulation and measuring its various parameters:
  - Voltage gain in dB.
  - Phase vs. Frequency.
  - Absolute V (Vabs).
...
### Session 2
- Designing an equivalent Thevenin's circuit.
...
- Done the AC analysis and observed the Bode plot of both the RC & CR filters.
...
#### IC Design Flow
- Got a detailed overview of the [IC Design Flow](https://github.com/silicon-vlsi/SI-2026-AnalogIC/blob/main/content/lec-intro-vlsi-0602-2026.pdf).
- Got familiar with different types of ICs and their working.

### Session 2

#### Op-Amp Pole Testing
- Modeled the Op-Amp as a single-pole amplifier (pole was found from the [datasheet](https://www.ti.com/lit/ds/symlink/opa345.pdf)) and reran all the above measurements of the MEMS mic.

#### MEMS Mic Breakout Board Testing
- Used the breakout board of the MEMS microphone and applied different frequencies (1 kHz & 2 kHz) to measure the output voltage and different parameters using [ADALM2000](https://www.analog.com/en/resources/evaluation-hardware-and-software/evaluation-boards-kits/adalm2000.html) and [SCOPY](https://github.com/analogdevicesinc/scopy).
- Done the FFT analysis of the input & output wave using the [SCOPY](https://github.com/analogdevicesinc/scopy) software.
- Observed the relation between frequency and distance with the Vpk-Vpk and power.
...
- Got to know the physics behind the resistance modelling in the IC design process.
...
- Derived the terms related to capacitance in a capacitor.
- Got to know the different MOS capacitances and capacitors in an IC.
- Got the idea of how the modelling of capacitors is done in ICs.
...
- Got to know the different operating conditions of the MOSFETs along with their properties.

### Session 2

#### Semiconductor Simulation
- Studied the cross-section of the MOSFET with different conditions using [SILWIZ](https://app.siliwiz.com/).
- Observed the different regions of operation along with their simulation using [SILWIZ](https://app.siliwiz.com/).
...
#### MOS Capacitances
- Studied the different capacitances built up in a diode (Depletion and Diffusion Capacitances).
- Got to know the effects of different intrinsic (parasitic) capacitances on the function of a MOS amplifier.
- Studied the effect of intrinsic capacitances on a MOS device at higher frequencies.
- Analyzed them with a Bode plot.
- Getting started with the basics of small signal analysis of MOSFET.
...
- Studied the different MOS amplifier configurations along with their small signal model.
...
- Understood the basics and working of different types of current mirrors.
- Calculated the input and output waveforms of a simple NMOS current mirror.

### Session 2

#### Analysis and Simulation of Current Mirror
- Derived different parameters of the current mirror to help in modelling.
- Done the small signal analysis of the cascode current mirror.
- Constructed the schematic of the current mirror in XSCHEM.
- Simulated and obtained the parameters like gain, phase, and gain margin by AC analysis.
...
- Got to know the basics of a differential amplifier.
- Studied the working and different configurations of a differential amplifier.
- Simulated different configurations of the differential amplifier and found out:
  - Gain, gain margin, phase margin, and AC response through AC analysis.
  - Current at different branches and different node voltages through DC sweep.
  - Input and output waveforms through transient analysis.
...
- Getting started with the layout of the differential amplifier.
- Constructed the layout of the lower half of the differential amplifier using [MAGIC VLSI](https://github.com/RTimothyEdwards/magic.git).
...
#### Getting Started with the 2-Stage Op-Amp
- Completing the LVS of the differential amplifier using NETGEN.
- Studied the basics of the 2-stage Op-Amp.
- Studied the circuit configuration and construction of the 2-stage Op-Amp and the need for this amplifier.

### Session 2

#### Construction and Simulation of the 2-Stage Op-Amp
- Constructed and simulated the 2-stage Op-Amp circuit using XSCHEM.
